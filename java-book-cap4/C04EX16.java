...
/* 
 * O programa a seguir é uma réplica do programa C04EX15.java, porém utilizaremos a
 * cláusula finally para dar uma ideia do seu uso
 */
...
public class C04EX16 {
	...
	public static void main(String[] args) {
		...
		System.out.println();
			...
			System.out.println();
			System.out.print("Passei pelo bloco: finally.");
			System.out.println();
